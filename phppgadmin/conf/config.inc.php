<?php
	...
	$conf['servers'][0]['host'] = 'ec2-54-83-203-50.compute-1.amazonaws.com';
	...
	$conf['servers'][0]['pg_dump_path'] = '/usr/lib/postgresql/9.4/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = 'C:\\Program Files\\PostgreSQL\\9.4\\bin\\pg_dumpall.exe';
